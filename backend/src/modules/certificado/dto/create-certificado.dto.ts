...
export class CreateCertificadoDto {
  ...
  @MaxLength(50, {
    message: 'Lote do certificado não pode ter mais que 50 caracteres',
  })
  ...
  @MaxLength(50, {
    message: 'Número do certificado não pode ter mais que 50 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Fornecedor não pode ter mais que 200 caracteres',
  })
  fornecedor: string;
  ...
  @MaxLength(50, {
    message: 'Número do pedido não pode ter mais que 50 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Peso molecular não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Fórmula molecular não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Nome científico não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message:
      'Características organolépticas não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Solubilidade não pode ter mais que 400 caracteres',
  })
  solubilidade?: string;
  ...
  @MaxLength(400, {
    message: 'Faixa de fusão não pode ter mais que 400 caracteres',
  })
  faixaFusao?: string;
  ...
  @MaxLength(400, {
    message: 'Densidade sem compactação não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Avaliação do laudo não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Perda por secagem não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Infravermelho não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Ultravioleta não pode ter mais que 400 caracteres',
  })
  ultraVioleta?: string;
  ...
  @MaxLength(400, {
    message: 'Conservação não pode ter mais que 400 caracteres',
  })
  conservacao?: string;
  ...
  @MaxLength(400, {
    message: 'Observação 01 não pode ter mais que 400 caracteres',
  })
  observacao01?: string;
  ...
  @IsOptional()
  @IsString({
    message: 'Determinação de materiais estranhos deve ser uma string',
  })
  @MaxLength(400, {
    message:
      'Determinação de materiais estranhos não pode ter mais que 400 caracteres',
  })
  ...
  @IsOptional()
  @IsString({
    message: 'Pesquisas de contaminação microbiológica deve ser uma string',
  })
  @MaxLength(400, {
    message:
      'Pesquisas de contaminação microbiológica não pode ter mais que 400 caracteres',
  })
  ...
  @MaxLength(400, {
    message: 'Caracteres microscópicos não pode ter mais que 400 caracteres',
  })
  ...
  @ApiProperty({
    description: 'ID da ficha técnica associada',
    example: 'uuid-da-ficha-tecnica',
    format: 'uuid',
  })
