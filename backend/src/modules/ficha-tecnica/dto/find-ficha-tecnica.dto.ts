...
export class FindFichaTecnicaDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ description: 'Buscar por produto', example: 'Paracetamol' })
  @IsOptional()
  @IsString({ message: 'Produto deve ser texto' })
  produto?: string;

  @ApiPropertyOptional({ description: 'Buscar por DCB', example: 'Paracetamol' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Data de análise inicial', example: '2024-01-01' })
  @IsOptional()
  @IsDateString({}, { message: 'Data inicial deve estar em formato válido (YYYY-MM-DD)' })
  dataInicialAnalise?: string;

  @ApiPropertyOptional({ description: 'Data de análise final', example: '2024-12-31' })
  @IsOptional()
  @IsDateString({}, { message: 'Data final deve estar em formato válido (YYYY-MM-DD)' })
  dataFinalAnalise?: string;

  @ApiPropertyOptional({ description: 'Busca geral em campos principais', example: 'paracetamol' })
  @IsOptional()
