...
export class CreateFichaTecnicaDto {
  ...
  @MaxLength(200, {
    message: 'Código da fórmula certa deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Peso molecular deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Fórmula molecular deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Nome científico deve ter no máximo 200 caracteres',
  })
  ...
  @ApiProperty({
    description: 'Análise',
    maxLength: 200,
    example: 'Análise química completa',
  })
  @IsOptional()
  ...
  @MaxLength(200, {
    message:
      'Características organolépticas devem ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Faixa de fusão deve ter no máximo 200 caracteres',
  })
  faixaFusao?: string;
  ...
  @MaxLength(200, {
    message: 'Densidade com compactação deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message:
      'Determinação de materiais estranhos deve ter no máximo 200 caracteres',
  })
  ...
  @IsOptional()
  @IsString({
    message: 'Pesquisas de contaminação microbiológica deve ser texto',
  })
  @MaxLength(200, {
    message:
      'Pesquisas de contaminação microbiológica deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Caracteres microscópicos deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Avaliação do laudo deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Perda por secagem deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Infravermelho deve ter no máximo 200 caracteres',
  })
  ...
  @MaxLength(200, {
    message: 'Observação 01 deve ter no máximo 200 caracteres',
  })
  observacao01?: string;
  ...
  @MaxLength(200, {
    message: 'Referência bibliográfica deve ter no máximo 200 caracteres',
  })
  ...
  @IsDateString(
    {},
    { message: 'Data de análise deve estar em formato válido (YYYY-MM-DD)' },
  )
