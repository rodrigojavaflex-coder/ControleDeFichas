-- RN-PCP-008: exclusões de fórmula (módulo RECEITAS) — espelho do agente
...
-- Confirmação pós-parse (cdfil-nrrqu-serier): NOT EXISTS em fc12100
-- SELECT FIRST 1 1 FROM fc12100 req
